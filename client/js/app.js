...
angular
  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider,
    ...
    $stateProvider
      .state('add-visita', {
        url: '/add-visita',
        templateUrl: 'views/visita-form.html',
        controller: 'AddVisitaController',
        authenticate: true
      })
      .state('all-visitas', {
        url: '/all-visitas',
        templateUrl: 'views/all-visitas.html',
        controller: 'AllVisitasController'
      })
      .state('edit-visita', {
        url: '/edit-visita/:id',
        templateUrl: 'views/visita-form.html',
        controller: 'EditVisitaController',
        authenticate: true
      })
      .state('delete-visita', {
        url: '/delete-visita/:id',
        controller: 'DeleteVisitaController',
        authenticate: true
      })
      .state('forbidden', {
        url: '/forbidden',
      ...
      .state('my-visitas', {
        url: '/my-visitas',
        templateUrl: 'views/my-visitas.html',
        controller: 'MyVisitasController',
        authenticate: true
      })
      .state('sign-up', {
        url: '/sign-up',
    ...
    $urlRouterProvider.otherwise('all-visitas');
  }])
